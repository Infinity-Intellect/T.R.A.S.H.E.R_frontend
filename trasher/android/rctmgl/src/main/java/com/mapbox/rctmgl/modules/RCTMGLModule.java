...
public class RCTMGLModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        styleURLS.put("Street", Style.STREETS);
    ...
    @ReactMethod
    public void setRestAPIKey(final String restKey) {
    ...
    public void setAllowOtherUrls(final boolean allowOtherUrls) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setAllowOtherUrls(allowOtherUrls);
            }
        });
    }
